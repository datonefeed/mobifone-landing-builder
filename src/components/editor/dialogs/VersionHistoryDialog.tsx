...
export function VersionHistoryDialog({
  ...
  const handleApply = (version: LandingPageVersion) => {
    setConfirmDialog({ open: true, type: "apply", version });
  };
  ...
  const handleDelete = (version: LandingPageVersion) => {
    setConfirmDialog({ open: true, type: "delete", version });
  };
  ...
  return (
    <>
                      ...
                      .map((version) => (
                        <div
                          ...
                          className={`border rounded-lg p-4 hover:border-blue-400 transition-colors ${
                            version.id === activeVersionId ? "border-green-500 bg-green-50" : ""
                          }`}
                        >
                          <div className="flex items-start justify-between mb-2">
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <p className="text-sm text-blue-800">
                    <strong>Note:</strong> This will save the current state of your landing page.
                    You can restore it anytime from the version history.
                  </p>
                </div>
              </div>
      ...
      {/* Confirm Dialogs */}
      <ConfirmDialog
        open={confirmDialog.open && confirmDialog.type === "apply"}
        onOpenChange={(open) => setConfirmDialog({ ...confirmDialog, open })}
        title="Apply Version"
        description={`Apply version "${confirmDialog.version?.name}"? Your current changes will be replaced with this version.`}
      ...
      <ConfirmDialog
        ...
        description={`Delete version "${confirmDialog.version?.name}"? This action cannot be undone.`}
        confirmText="Delete"
        cancelText="Cancel"
